    ...
    
    {
...

     {
      ...
      timestamps: {
        ...
        kn:[
          { time: "00:57:20", label: "ದೇವರ ಪ್ರಸ್ತಾವನೆ ದೇವರು ನಮ್ಮನ್ನು ಹಿಂದಿನ ಶ್ರೇಷ್ಠತೆಗಿಂತಲೂ ಹೆಚ್ಚಿನ ಮಹಿಮೆಗೆ ಕರೆದಿದ್ದಾರೆ. ಹಿಂದಿನ ದಿನಗಳನ್ನು ನೆನೆಯುವ ಬದಲು, ಮುಂದಿನ ದೇವರ ಕಾರ್ಯವನ್ನು ನಿರೀಕ್ಷಿಸಬೇಕು." },
          { time: "01:07:00", label: "ಸೋಲೊಮೋನನ ಆಲಯ vs. ಎರಡನೇ ಆಲಯ:ಮೊದಲು ನಿರ್ಮಿಸಲಾದ ಆಲಯವು ಭವ್ಯವಾಗಿತ್ತು, ಆದರೆ ದೇವರು ಮುಂದಿನ ಆಲಯವನ್ನು ಹೆಚ್ಚು ಶ್ರೇಷ್ಠಗೊಳಿಸುತ್ತಾರೆ." },
          { time: "00:39:00", label: "ಆಬ್ರಹಾಮ ಮತ್ತು ಸಾರಳಿಗೆ ದೇವರ ವಾಗ್ದಾನ:ಸಾರಳಿಗೆ 90ನೇ ವಯಸ್ಸಿನಲ್ಲಿ ಮಗುವಾದುದು (ಇಸಾಕ್) – ಇದು ಒಂದು ದೇವದತ್ತ ಅದ್ಭುತ." },
          { time: "01:03:00", label: "ಯೋಸೇಫನ ಕನಸುಗಳರ್ಥ:ಯೋಸೇಫ್ ತನ್ನ ಕನಸುಗಳ ಮೂಲಕ ತನ್ನ ಭವಿಷ್ಯವನ್ನು ನೋಡಿದನು.ಐಗುಪ್ತ ದೇಶದ ಪಡುವಣದ ಸನ್ನಿವೇಶದಲ್ಲಿ ಅವನು ರಾಜನೊಂದಿಗೆ ಎದ್ದು ಬಂದನು." }
         { time: "01:03:00", label: "ನೆಬೂಕದ್ನೇಸರ್ ರಾಜನ ಕನಸು ಮತ್ತು ದಾನಿಯೇಲನು:ದಾನಿಯೇಲನು ಒಬ್ಬ ದೈವಜ್ಞಾನಿ – ದೇವರು ದಾನಿಯೇಲನಿಗೆ ಕಂಡ ಕನಸು ಮತ್ತು ಅದರ ಅರ್ಥವನ್ನು ಪ್ರತ್ಯಕ್ಷವಾಗಿ ತಿಳಿಸಿದರು." }
  { time: "01:03:00", label: "ಎಲಿಯ ಮತ್ತು ಎಲೀಷನ ಅದ್ಭುತ ಕಾರ್ಯಗಳು ಎಲಿಯನು: ಮಳೆ ಬರದೆ ಇದ್ದಾಗ ಪ್ರಾರ್ಥನೆ ಮಾಡಿದರು → ದೇವರು ಚಿಕ್ಕ ಮೋಡದಿಂದ ಭಾರಿ ಮಳೆ ತರಿಸಿದರು. " }     
       { time: "01:03:00", label: "ಮರಣದಿಂದ ಜೀವಕ್ಕೆ: ಎಲಿಯ, ಎಲೀಷ ಮತ್ತು ಎಜ್ಕೆಲ್" } 
{ time: "01:03:00", label: "ನೋಹ ಮತ್ತು ಪೇತ್ರನು:ನೋಹನ ಹಡಗು: 8 ಜನರು ಪೇತ್ರನು ಒಂದು ಪ್ರಸಂಗದಿಂದ 3000 ಜನರ ರಕ್ಷಣೆ." }
